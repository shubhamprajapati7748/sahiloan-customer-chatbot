#!/usr/bin/env python3
"""
Simple script to ingest markdown documents to Pinecone.

Usage:
    poetry run python ingest_data.py <path_to_data>
    
Example:
    poetry run python ingest_data.py ./data
    poetry run python ingest_data.py ./data/my_document.md
"""
import sys
